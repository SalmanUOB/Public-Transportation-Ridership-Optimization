...
import 'delete_bookings_model.dart';
export 'delete_bookings_model.dart';

class DeleteBookingsWidget extends StatefulWidget {
  const DeleteBookingsWidget({super.key});

  @override
  State<DeleteBookingsWidget> createState() => _DeleteBookingsWidgetState();
}

class _DeleteBookingsWidgetState extends State<DeleteBookingsWidget>
    with TickerProviderStateMixin {
  late DeleteBookingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteBookingsModel());
  }
                                              ...
                                              Padding(
                                                ...
                                                child: StreamBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return Text(
                                                      'Student Name: ${textUsersRecord?.displayName}',
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        12.0, 0.0, 0.0, 0.0),
                                                child: Text(
                                                  'Booking ID: ${listViewBookingsRecord.bookingID}',
                                              ...
                                              Padding(
                                                ...
                                                child: StreamBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return Text(
                                                      '${textStationsRecord?.name} at ${textStationsRecord?.cityname}',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyLarge
                                                          .override(
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        '${dateTimeFormat("MMMEd", listViewBookingsRecord.date)} at ${listViewBookingsRecord.time}',
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .labelMedium
                                                            .override(
