...
import 'schema/governorates_record.dart';
import 'schema/cities_record.dart';
import 'schema/stations_record.dart';
...
export 'schema/governorates_record.dart';
export 'schema/cities_record.dart';
export 'schema/stations_record.dart';
...
/// Functions to query GovernoratesRecords (as a Stream and as a Future).
Future<int> queryGovernoratesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      GovernoratesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<GovernoratesRecord>> queryGovernoratesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      GovernoratesRecord.collection,
      GovernoratesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<GovernoratesRecord>> queryGovernoratesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query StationsRecords (as a Stream and as a Future).
Future<int> queryStationsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      StationsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<StationsRecord>> queryStationsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      StationsRecord.collection,
      StationsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<StationsRecord>> queryStationsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
