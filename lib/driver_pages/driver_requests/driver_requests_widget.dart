...
import 'driver_requests_model.dart';
export 'driver_requests_model.dart';

class DriverRequestsWidget extends StatefulWidget {
  const DriverRequestsWidget({super.key});

  @override
  State<DriverRequestsWidget> createState() => _DriverRequestsWidgetState();
}

class _DriverRequestsWidgetState extends State<DriverRequestsWidget>
    with TickerProviderStateMixin {
  late DriverRequestsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverRequestsModel());
  }
                                                                ...
                                                                var confirmDialogResponse =
                                                                    await showDialog<
                                                                          ...
                                                                          builder:
                                                                              (alertDialogContext) {
                                                                            return AlertDialog(
                                                                              content: Text('Are you sure to reject the booking? '),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                  child: Text('Cancel'),
