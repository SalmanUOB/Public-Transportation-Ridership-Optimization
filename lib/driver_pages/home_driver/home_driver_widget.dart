...
import 'home_driver_model.dart';
export 'home_driver_model.dart';
...
class HomeDriverWidget extends StatefulWidget {
  ...
  final DocumentReference? usersname;
...
class _HomeDriverWidgetState extends State<HomeDriverWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeDriverModel());
  }
            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => StreamBuilder<List<BookingsRecord>>(
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(12.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      '${dateTimeFormat("MMMEd", listViewBookingsRecord.date)}',
                                                          ...
                                                          var confirmDialogResponse =
                                                              await showDialog<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        content:
                                                                            Text('Are you sure to accept the booking? '),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                          ...
                                                          var confirmDialogResponse =
                                                              await showDialog<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        content:
                                                                            Text('Are you sure to reject the booking? '),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                                Navigator.pop(alertDialogContext, false),
