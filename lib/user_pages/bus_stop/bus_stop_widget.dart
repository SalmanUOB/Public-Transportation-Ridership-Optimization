...
class BusStopWidget extends StatefulWidget {
  ...
  final DocumentReference? cityID;
  final DocumentReference? stations;
...
class _BusStopWidgetState extends State<BusStopWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusStopModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.checkStation = await queryBusesRecordOnce(
        singleRecord: true,
